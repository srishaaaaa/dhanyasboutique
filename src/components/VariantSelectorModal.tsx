      ...
      {open && (
        <>
          ...
          <motion.div
            ...
            className="fixed inset-0 z-50 bg-shopDeep/50 backdrop-blur-[2px]"
            onClick={onClose}
          />
                    ...
                    <button
                      ...
                      className={[
                        ...
                        isSelected
                          ...
                          : 'ring-1 ring-gray-200 hover:ring-shopCard active:bg-gray-50',
                      ].join(' ')}
                    >
                      {/* Radio circle */}
                      <span
                ...
                <motion.button
                  ...
                  className={[
                    ...
                    added
                      ...
                      : 'bg-[#111111] text-white hover:bg-shopDeep',
                  ].join(' ')}
                >
                  {added ? (
                    <>
