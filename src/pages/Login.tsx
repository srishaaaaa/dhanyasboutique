      ...
      >
        ...
        <div className={`hidden lg:flex items-center relative transition-all duration-300 ${sidebarCollapsed ? 'flex-col items-center pt-5 pb-4 px-2 gap-3' : 'px-5 py-5 justify-between'}`}>
          <Link to="/pos" title="Go to Billing Panel" className={`flex items-center gap-3 min-w-0 transition-all duration-300 ${sidebarCollapsed ? 'justify-center' : 'flex-1'}`}>
            <div className="flex items-center justify-center shrink-0 w-11 h-11 rounded-xl bg-shopDeep border border-[#BE7D40] shadow-sm overflow-hidden p-1 hover:scale-105 transition-transform">
          ...
          <button
            ...
            className="flex h-8 w-8 items-center justify-center rounded-xl bg-white/10 text-white hover:bg-white/15 hover:text-white transition-colors shrink-0"
        ...
        {/* Mobile mini-header */}
        <div className="flex lg:hidden items-center justify-between px-4 py-4 border-b border-white0">
          <Link to="/pos" title="Go to Billing Panel" className="flex items-center gap-3 min-w-0">
            <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-shopDeep border border-[#BE7D40] shrink-0 overflow-hidden shadow-sm p-1 hover:scale-105 transition-transform">
              <img src={BRAND_LOGO} alt={`${BRAND_EN} logo`} className="w-full h-full object-contain" />
            </div>
        ...
        >
          {navItems.map(item => (
            <button
              ...
              className={[
                ...
                tab === item.id ? 'bg-white text-maroon-dark shadow-sm' : 'text-white hover:bg-white/10 hover:text-white',
              ].join(' ')}
            >
          ...
          <button
            ...
            className={[
              ...
              sidebarCollapsed ? 'lg:w-[48px] lg:justify-center mx-auto' : 'lg:px-4',
              'px-0 py-1 lg:py-0',
              'rounded-xl font-medium text-[11px] lg:text-[14px] transition-all text-white hover:bg-white/10 hover:text-white lg:mt-auto mb-1 lg:mb-4 overflow-hidden',
            ].join(' ')}
          >
