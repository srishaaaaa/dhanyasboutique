...
export default function ProductDetails() {
  ...
  if (loading) return <div className="min-h-screen bg-shopTint p-10 text-center font-bold text-[#2c392a]">Loading...</div>
  if (error || !product) return <div className="min-h-screen bg-shopTint p-10 text-center font-bold text-red-500">{error || 'Product not found'}</div>
  ...
  return (
    <div className="min-h-screen bg-shopTint pb-[calc(7.75rem+env(safe-area-inset-bottom))]">
      <div className="lg:hidden sticky top-0 z-30 border-b border-white/60 bg-shopTint/92 px-4 py-3 backdrop-blur sm:px-6">
