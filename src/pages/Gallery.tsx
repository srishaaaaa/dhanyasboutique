...
function Lightbox({
  ...
  return (
    <motion.div
      className="fixed inset-0 z-[100] bg-shopDeep/96 flex flex-col items-center justify-center"
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
      exit={{ opacity: 0 }}
  ...
  return (
    <div className="bg-[#F9FAFB] min-h-screen">
      ...
      >
        ...
        >
          <p className="text-[10px] font-black uppercase tracking-[0.26em] text-shopCard mb-4">
            Rice n' Rooster
          </p>
          <h1 className="text-[2.8rem] sm:text-[3.6rem] font-black text-[#111111] tracking-tight leading-[1.02] mb-4">
            Inside Our Store
          </h1>
          <p className="text-[16px] sm:text-[18px] font-black text-shopCard mb-4">
          ...
          {galleryImages.map((img, idx) => (
            ...
            >
              <div className="relative overflow-hidden rounded-[20px] sm:rounded-[24px]
                ...
                transition-shadow duration-300 bg-shopSoft/20">
                <img
                  src={img.image}
                  alt={img.title}
                  loading="lazy"
