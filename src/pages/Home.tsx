    ...
    <div className="bg-[#F9FAFB] text-[#111111]">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 w-full grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-14 items-center">
          ...
          >
            ...
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full mb-6
              bg-shopCard/10 border border-shopCard/20">
            ...
            <h1 className="font-black mb-5 break-words font-headline text-[40px] sm:text-[54px] lg:text-[66px] leading-[1.0] tracking-[-0.02em]">
              ...
              <span className="block text-shopCard">{t('hero.title2')}</span>
            </h1>
            ...
            <div className="flex flex-wrap gap-3 items-center">
              ...
              <a
                ...
                className="inline-flex items-center gap-2 px-6 py-3.5
                  ...
                  transition-all duration-200"
              >
                <Leaf size={13} className="text-shopCard" />
                {t('remedy.title')}
              </a>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="relative w-full max-w-[620px] aspect-video rounded-[2rem] overflow-hidden
              ...
              bg-gradient-to-br from-shopDeep via-[#1e1a10] to-[#2a2418]">
            ...
            >
              <div className="bg-white rounded-2xl px-4 py-3.5
                ...
                border border-shopSoft/50
                flex items-center gap-3">
                <div className="w-8 h-8 rounded-xl bg-shopCard flex items-center justify-center shrink-0">
          ...
          {[
            ...
            <div key={idx}
              className="flex items-center gap-3.5 p-4 sm:p-5
                ...
                border border-shopSoft/35
                shadow-sm
                hover:-translate-y-0.5 transition-transform duration-200"
            >
              <div className="w-9 h-9 rounded-xl bg-shopCard/12 flex items-center justify-center shrink-0 text-shopCard">
                {item.icon}
              </div>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 py-16 sm:py-24">
        <div className="flex justify-between items-end mb-10">
          <div>
            <p className="text-[10px] font-black uppercase tracking-[0.22em] text-shopCard mb-2">Browse Collection</p>
            <h2 className="font-black text-[#111111] break-words text-3xl sm:text-[38px] tracking-tight">{t('cat.title')}</h2>
          </div>
          <Link to="/products"
            className="text-[13px] font-bold text-shopCard flex items-center gap-1 group hover:text-[#5e8c72] transition-colors">
            {t('cat.view_all')}
            ...
            >
              <Link to={`/products?cat=${encodeURIComponent(c.name)}`} className="flex flex-col items-center group">
                ...
                <div className="w-full aspect-square rounded-2xl overflow-hidden relative
                  border border-shopSoft/30 shadow-sm
                ...
                <span className="text-[10px] sm:text-[11px] font-bold text-[#111111] text-center leading-tight
                  group-hover:text-shopCard transition-colors duration-200">
                  {c.name}
                </span>
              </Link>
            </motion.div>
      ...
      {/* ═══ HEALTH CONCERNS ═══ */}
      <section id="concerns" className="bg-white py-16 sm:py-24 border-y border-shopSoft/30 scroll-mt-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 text-center">
          <div className="mb-12">
            <p className="text-[10px] font-black uppercase tracking-[0.22em] text-shopCard">{t('remedy.badge')}</p>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 py-16 sm:py-24">
        <div className="flex justify-between items-center mb-10">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-[10px] font-black uppercase tracking-[0.18em] text-shopCard">Customer Favourites</p>
              <h2 className="font-black text-[#111111] break-words text-2xl sm:text-3xl tracking-tight">{t('top.title')}</h2>
            </div>
          </div>
          <Link to="/products"
            className="text-[13px] font-bold text-shopCard hover:text-[#5e8c72] flex items-center gap-1 transition-colors">
      ...
      <section className="bg-white py-16 sm:py-24 border-y border-shopSoft/30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 mb-12">
            <div>
              <p className="text-[10px] font-black uppercase tracking-[0.22em] text-shopCard">Customer Reviews</p>
            ...
            <button
              ...
              className="shrink-0 inline-flex items-center gap-2 px-5 py-3 rounded-xl
                ...
                hover:bg-shopDeep transition-colors"
            >
          ...
          <AnimatePresence>
            {showForm && (
              <motion.form
                ...
                className="mb-10 bg-[#F9FAFB] rounded-2xl p-6 border border-shopSoft/40 overflow-hidden"
              >
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-2.5 rounded-xl border-2 border-shopSoft focus:border-shopCard outline-none bg-white text-[13px]"
                ...
                <div className="mb-5">
                  ...
                  <textarea
                    ...
                    className="w-full px-4 py-2.5 rounded-xl border-2 border-shopSoft focus:border-shopCard outline-none bg-white text-[13px] resize-none"
                ...
                <div className="flex gap-3">
                  <button type="submit" disabled={submitting}
                    className="inline-flex items-center gap-2 px-6 py-2.5 rounded-xl bg-shopCard hover:bg-[#5e8c72] text-white font-bold text-[13px] transition-colors disabled:opacity-60">
                    {submitting
                  ...
                  <button type="button" onClick={() => { setShowForm(false); setReviewError('') }}
                    className="px-5 py-2.5 rounded-xl border-2 border-shopSoft text-[#374151] font-bold text-[13px] hover:bg-[#F9FAFB] transition-colors">
                    Cancel
                  </button>
                </div>
              </motion.form>
          ...
          {reviewsLoading && (
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 mb-5">
              {[1, 2, 3, 4].map(i => (
                <div key={i} className="bg-[#F9FAFB] rounded-2xl p-5 border border-shopSoft/30 animate-pulse">
                  <div className="h-3 bg-shopSoft rounded w-24 mb-4" />
                  <div className="h-2.5 bg-shopSoft rounded w-full mb-2" />
                  <div className="h-2.5 bg-shopSoft rounded w-4/5 mb-2" />
                  <div className="h-2.5 bg-shopSoft rounded w-3/5" />
                </div>
              ))}
            </div>
          )}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
            {TESTIMONIALS.map((review, idx) => (
              <motion.div
                ...
                className="bg-[#F9FAFB] rounded-2xl p-5 sm:p-6 border border-shopSoft/30 flex flex-col gap-3.5 hover:shadow-md transition-shadow duration-300"
              >
                ...
                <div className="flex items-center gap-2.5 pt-3 border-t border-shopSoft/40">
            ...
            {customerReviews.slice(0, 8).map((review) => {
              const colors = ['rgb(var(--shop-card-rgb))', '#C4845C', '#8B7355', '#5e8c72']
              ...
              return (
                <motion.div
                  ...
                  animate={{ opacity: 1, scale: 1 }}
                  className="bg-[#F9FAFB] rounded-2xl p-5 sm:p-6 border border-shopCard/20 flex flex-col gap-3.5 hover:shadow-md transition-shadow duration-300"
                >
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-[9px] font-bold text-shopCard bg-shopCard/10 px-2 py-0.5 rounded-full">Verified</span>
                  </div>
                  <p className="text-[13px] text-[#374151] leading-[1.65] flex-grow">&ldquo;{review.text}&rdquo;</p>
                  <div className="flex items-center gap-2.5 pt-3 border-t border-shopSoft/40">
                    <div className="w-8 h-8 rounded-full flex items-center justify-center text-white text-[10px] font-black shrink-0"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 items-stretch">
          ...
          <a
            ...
            className="group relative rounded-[2rem] overflow-hidden
              border border-shopSoft/40 shadow-sm
          ...
          >
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center gap-4 z-10">
              ...
              <div className="inline-flex items-center gap-1.5 px-4 py-2 rounded-xl
                ...
                group-hover:bg-shopCard transition-colors duration-300">
          ...
          <div className="bg-white rounded-[2rem] p-8 sm:p-10
            ...
            <div>
              <p className="text-[10px] font-black uppercase tracking-[0.22em] text-shopCard">Find Us</p>
              ...
              <div className="space-y-3.5">
                <div className="flex items-center gap-3">
                  <div className="w-9 h-9 rounded-xl bg-shopCard/12 flex items-center justify-center shrink-0">
                    <MapPin size={16} className="text-shopCard" />
                  </div>
                  <div>
                ...
                <div className="flex items-center gap-3">
                  <div className="w-9 h-9 rounded-xl bg-shopCard/12 flex items-center justify-center shrink-0">
                    <Phone size={16} className="text-shopCard" />
                  </div>
                  <div>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 pb-16 sm:pb-24 text-center">
        ...
        <Link
          ...
          className="inline-flex items-center gap-2.5 px-10 py-4 rounded-full
            bg-shopCard text-white font-black
