...
export default function DigitalInvoice() {
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-white flex items-center justify-center">
        <span className="w-8 h-8 border-4 border-shopSoft border-t-shopCard rounded-full animate-spin" />
      </div>
    )
  }
  ...
  return (
    <div className="app-scroll-root h-full overflow-y-auto hide-scrollbar bg-white font-sans pb-12 print:bg-white print:pb-0">
      {/* Top action bar */}
      <div className="bg-white border-b border-shopSoft/40 p-3 sm:p-4 sticky top-0 z-50 print:hidden flex flex-wrap items-center justify-between gap-2 max-w-4xl mx-auto">
        <button onClick={handleBack} className="flex items-center gap-2 text-[#374151] hover:text-[#111111] font-semibold text-sm transition-colors bg-white border border-shopSoft/60 px-3 sm:px-4 py-2 rounded-full shadow-sm cursor-pointer">
          <ArrowLeft size={16} /> Back
        </button>
      ...
      <div className="max-w-3xl mx-auto mt-4 print:mt-0 px-2 sm:px-0">
        <div
          ...
          className="flex flex-col bg-white shadow-xl rounded-2xl overflow-hidden print:shadow-none print:rounded-none border border-shopSoft/40 print:border-none print:!min-h-0"
