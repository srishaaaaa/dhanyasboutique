                ...
                <div className="flex items-center gap-2 flex-wrap">
                  ...
                  {([
                    ...
                    <button key={p.id} onClick={() => applyPreset(p.id)}
                      className={`px-3.5 py-1.5 rounded-lg text-[11px] font-bold uppercase whitespace-nowrap transition-colors ${datePreset === p.id ? 'bg-shopDeep text-white' : 'text-[#6B7280] bg-white border border-[#E5E7EB] hover:bg-[#F9FAFB]'}`}>
                      {p.label}
                    </button>
                  ))}
                </div>
