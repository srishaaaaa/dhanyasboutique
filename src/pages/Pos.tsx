        ...
        <div className="max-w-2xl mx-auto px-4 py-6 print:hidden space-y-4">
          ...
          <Card padding="md">
            ...
            <div className="space-y-2.5">
              <div className="flex justify-between items-center pb-2.5 border-b border-shopSoft/40">
          ...
          <div className="grid grid-cols-3 gap-2.5">
            <button onClick={() => printReceipt(invoice)}
              className="flex flex-col items-center justify-center gap-1.5 rounded-xl border border-shopSoft/60 bg-white py-3 text-[#374151] hover:bg-[#F9FAFB] transition-colors">
    ...
    <div data-embedded={embeddedMode} data-panel={mobilePanelView} className={`flex flex-col bg-[#FAFAFA] print:hidden ${embeddedMode ? '' : 'app-scroll-root h-full overflow-y-auto overflow-x-hidden hide-scrollbar'}`}>
      ...
      <div className="px-4 pt-4 pb-3 md:px-6 md:pt-6 md:pb-4 shrink-0 flex flex-col gap-4 min-[480px]:flex-row min-[480px]:items-start min-[480px]:justify-between">
        <div className="min-w-0">
          <h2 className="text-[28px] md:text-[22px] font-black text-shopCard flex items-start gap-2 leading-tight">
            <div className="w-1.5 h-6 bg-shopCard rounded-full"></div>
            POS Billing Panel
          </h2>
      ...
      <div className="flex flex-col lg:flex-row gap-5 md:gap-6 px-4 md:px-6 pb-6 lg:h-[calc(100vh-120px)] lg:overflow-hidden">
        ...
        <div className="flex-[2.1] flex flex-col gap-6 lg:overflow-y-auto lg:pb-4 hide-scrollbar">
          ...
          <Card padding="md">
            <h3 className="text-[14px] font-black text-[#111111] flex items-center gap-2 mb-4">
              <User size={16} className="text-shopCard" />
              Customer Details
            </h3>
          ...
          <Card padding="none" className="flex-1 flex flex-col min-h-[400px]">
            {/* Card Header */}
            <div className="flex flex-col gap-4 p-4 md:p-5 border-b border-shopSoft/40">
              <h3 className="text-[14px] font-black text-[#111111] flex items-center gap-2">
                <Receipt size={16} className="text-shopCard" />
                Order Items
              </h3>
              ...
              {customItemOpen && (
                <form
                  ...
                  className="mt-3 grid grid-cols-1 md:grid-cols-[minmax(0,1fr)_150px_auto] gap-2 rounded-xl border border-shopSoft/60 bg-[#FFFDFC] p-3"
                >
                  <Input
                    autoFocus
                    required
            ...
            {/* Table Header */}
            <div className="hidden md:grid grid-cols-[1fr_100px_120px_40px] gap-3 px-5 py-3 border-b border-shopSoft/20 bg-[#FAFAFA]">
            ...
            <div className="flex-1 overflow-y-auto hide-scrollbar p-3 space-y-3 md:space-y-2">
              ...
              {items.map(item => (
                <div key={item.id}>
                  <div className="md:hidden border border-shopSoft/30 rounded-2xl p-4 bg-[#FFFDFC] space-y-3">
                      ...
                      <div className="min-w-0 flex-1">
                        ...
                        {item.source === 'manual' ? (
                          <input
                            ...
                            className="w-full h-12 px-3 bg-[#FAFAFA] border border-shopSoft/40 rounded-xl text-[16px] font-bold text-[#111111] focus:outline-none focus:border-shopCard"
                          />
                        ) : (
                          <div className="rounded-xl border border-shopSoft/30 bg-white px-3 py-3">
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      <div>
                        ...
                        <input
                          ...
                          placeholder="0"
                          className={`w-full h-12 px-3 border rounded-xl text-[16px] font-black text-right focus:outline-none focus:border-shopCard ${
                            item.source === 'manual'
                              ? 'bg-[#FAFAFA] border-shopSoft/40 text-[#111111]'
                      ...
                      <div>
                        ...
                        <div className="h-12 rounded-xl border border-shopSoft/30 bg-white px-3 flex items-center justify-end text-[16px] font-black text-shopCard">
                    ...
                    <div>
                      ...
                      <div className="flex items-center justify-between gap-2 border border-shopSoft/60 rounded-xl px-2 py-1.5 bg-white">
                  ...
                  <div className="hidden md:grid grid-cols-[1fr_100px_120px_40px] items-center gap-3 p-2 bg-white border border-shopSoft/30 rounded-xl hover:border-shopCard/30 transition-colors">
                    {/* Item Name */}
                    <div className="min-w-0 flex items-center gap-2">
                      {item.source === 'manual' ? (
                        <input
                          ...
                          onChange={e => updateItem(item.id, 'name', e.target.value)}
                          placeholder="Item name"
                          className="w-full px-3 py-2 bg-[#FAFAFA] border border-shopSoft/40 rounded-lg text-[13px] font-bold text-[#111111] focus:outline-none focus:border-shopCard"
                        />
                      ) : (
                      ...
                      {item.source !== 'manual' && (
                        <span className="hidden sm:inline-flex px-2 py-0.5 rounded border border-shopCard/20 text-shopCard text-[9px] font-black tracking-wider uppercase shrink-0 bg-shopCard/5">
                          CATALOG
                        </span>
                      )}
                    </div>
                    ...
                    <div>
                      <input
                        ...
                        onChange={e => updateItem(item.id, 'basePrice', e.target.value)}
                        placeholder="0"
                        className={`w-full px-3 py-2 border rounded-lg text-[13px] font-black text-right focus:outline-none focus:border-shopCard ${
                          item.source === 'manual'
                            ? 'bg-[#FAFAFA] border-shopSoft/40 text-[#111111]'
                            : 'bg-white border-[#D9E4D7] text-[#111111]'
                        }`}
                    ...
                    {/* Quantity Controls */}
                    <div className="flex items-center justify-between border border-shopSoft/60 rounded-lg px-1 py-0.5 bg-white">
        ...
        <div className="flex-[1] flex min-h-0 flex-col gap-6 lg:sticky lg:top-4 lg:h-[calc(100vh-140px)] lg:max-h-[calc(100vh-140px)]">
          <div className="flex min-h-0 flex-col rounded-2xl border border-shopSoft/60 bg-[#FAF9F6] shadow-sm lg:h-full lg:max-h-full lg:overflow-hidden">

            {/* Header */}
            <div className="flex items-center justify-between p-3 border-b border-shopSoft/60 bg-white shrink-0">
            ...
            <div className="min-h-0 flex-1 lg:overflow-y-auto bg-white p-3 space-y-2 hide-scrollbar">
              ...
              {/* Info Table */}
              <div className="border border-shopSoft/40 rounded-xl overflow-hidden text-[11px] font-bold">
                <div className="flex justify-between px-3 py-2 border-b border-shopSoft/40 bg-[#FAFAFA]">
                  <span className="text-[#374151] uppercase">Source</span>
                  <span className="text-shopCard border border-shopCard/30 bg-shopCard/5 px-1.5 rounded uppercase">{ordermode.toUpperCase()}</span>
                </div>
                <div className="flex items-center justify-between gap-2 px-3 py-2 border-b border-shopSoft/40">
                  <div className="min-w-0 flex items-center gap-1.5 text-[#111111]">
                    <User size={12} className="shrink-0 text-shopCard" />
                ...
                {items.length > 0 && (
                  <div className="px-3 py-2 bg-[#FAFAFA] space-y-1 border-b border-shopSoft/40 max-h-[80px] overflow-y-auto hide-scrollbar">
                    {items.map(item => (
                ...
                <div className="flex gap-2">
                  <div className="relative h-9 w-16 shrink-0">
                    <select
                      ...
                      className="h-9 w-16 appearance-none rounded-xl border border-shopSoft/60 bg-white pl-3 pr-7 text-[12px] font-bold text-[#111111] outline-none transition-colors focus:border-shopCard"
                    >
              ...
              {/* GST Toggle */}
              <div className="py-1 border-b border-shopSoft/40">
              ...
              <div className="bg-[#FAFAF8] rounded-xl border border-shopSoft/40 p-2.5 space-y-1.5">
                ...
                <div className="flex items-center justify-between gap-2">
                  ...
                  <input
                    ...
                    className="h-9 w-20 shrink-0 box-border rounded-xl border border-shopSoft/60 bg-white px-2 text-[12px] font-bold text-[#111111] text-right outline-none transition-colors focus:border-shopCard"
                  />
                </div>

                <div className="h-px bg-shopSoft/60"></div>

                {/* Grand Total */}
                <div className="flex items-center justify-between pt-0.5">
                  <span className="text-[12px] font-black text-[#111111] uppercase tracking-wider">Grand Total</span>
                  <span className="text-2xl font-black text-shopCard tracking-tight">{formatCurrency(total)}</span>
                </div>
              </div>
              ...
              {ordermode !== 'online' && (
              <div>
                <div className="border border-shopSoft/60 rounded-xl p-2.5 bg-white">
                  ...
                  />
                  {cashReceivedNum > 0 && (
                    <div className="mt-2 flex justify-between items-center bg-[#F9FAFB] px-3 py-1.5 rounded-lg border border-shopSoft/40">
            ...
            <div className="shrink-0 border-t border-shopSoft/60 bg-white p-3 shadow-[0_-8px_20px_rgba(44,57,42,0.06)]">
      ...
      {depositOpen && (
        <div className="fixed inset-0 z-[90] flex items-center justify-center bg-shopDeep/55 p-4">
      ...
      {depositCreated && (
        <div className="fixed inset-0 z-[95] flex items-center justify-center bg-shopDeep/55 p-4">
