...
const STATUS_COLORS: Record<string, { bg: string; text: string; label: string }> = {
  ...
  completed: { bg: 'rgb(var(--shop-soft-rgb))', text: '#065F46', label: 'Completed' },
              ...
              <div className="flex flex-col items-center text-center mb-6 pb-6 border-b border-sand">
                <div className="relative mb-3">
                  ...
                  {isSupabaseConfigured && (
                    ...
                    >
                      {avatarUploading
                        ? <span className="w-3 h-3 border-2 border-white0 border-t-white rounded-full animate-spin" />
                        : <Camera size={13} />
                      }
                    </button>
                  )}
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex gap-3 pt-1">
                      <button onClick={handleSaveProfile} disabled={saving}
                        ...
                        {saving
                          ? <><span className="w-3.5 h-3.5 border-2 border-white0 border-t-white rounded-full animate-spin" /> Saving…</>
