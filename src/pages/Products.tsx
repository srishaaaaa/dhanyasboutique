...
export default function Products() {
  ...
  const SkeletonCard = () => (
    <div className="rounded-2xl border border-shopSoft/50 bg-white overflow-hidden animate-pulse">
      <div className="aspect-square bg-shopSoft/30" />
      <div className="p-3 space-y-2">
        <div className="h-2 bg-shopSoft/40 rounded w-1/2" />
        <div className="h-3 bg-shopSoft/40 rounded w-4/5" />
        <div className="h-3 bg-shopSoft/30 rounded w-3/5" />
        <div className="flex gap-1 mt-2">
          {[1,2,3,4].map(i => <div key={i} className="h-5 bg-shopSoft/30 rounded-lg w-10" />)}
        </div>
        <div className="flex justify-between items-center pt-2 border-t border-shopSoft/30 mt-2">
          <div className="h-5 bg-shopSoft/40 rounded w-14" />
          <div className="h-8 bg-shopSoft/40 rounded-xl w-16" />
        </div>
      </div>
    </div>
  )
  ...
  return (
    <div className="bg-bgMain min-h-screen">
      {/* Header Panel */}
      <div className="bg-white border-b border-shopSoft/30">
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 flex flex-col lg:flex-row gap-8">
        ...
        <div className="flex-grow">
          ...
          {loading ? (
            ...
            <div className="bg-white border border-shopSoft/40 rounded-3xl p-10 sm:p-20 text-center flex flex-col items-center">
               <div className="w-20 h-20 bg-[#F9FAFB] rounded-full flex items-center justify-center mb-6">
                 <Search className="text-shopSoft" size={32}/>
               </div>
               ...
               <button onClick={clear} className="text-sm font-black text-shopCard hover:underline">Clear all filters</button>
            </div>
          ) : (
