-- ============================================================
-- Sri Sakthi Pugazh Tex — consolidated database schema
--
-- Auto-generated by concatenating every file in supabase/migrations/
-- in the order Supabase applies them (sorted by filename), so
-- running this single file against a fresh database reproduces
-- the current schema. Each section below is one original migration
-- file, kept verbatim and in order — including later fixes that
-- superseded earlier statements (e.g. CREATE OR REPLACE FUNCTION),
-- so the LAST definition of any given object is the one that wins,
-- exactly as it does when migrations are applied one by one.
--
-- Do not hand-edit this file — edit/add files in supabase/migrations/
-- instead and regenerate. Generated: 2026-09-15T10:12:25Z
-- ============================================================


-- ============================================================
-- Source: supabase/migrations/20260716_0001_store_schema.sql
-- ============================================================
...
-- ============================================================
-- Source: supabase/migrations/20260716_0002_store_catalog.sql
-- ============================================================
...
-- ============================================================
-- Source: supabase/migrations/20260716_0003_order_rpc_compatibility.sql
-- ============================================================
...
-- ============================================================
-- Source: supabase/migrations/20260719_0004_advance_orders.sql
-- ============================================================
...
-- ============================================================
-- Source: supabase/migrations/20260722_0005_eight_digit_invoice_numbers.sql
-- ============================================================
...
-- ============================================================
-- Source: supabase/migrations/20260724_0006_fix_complete_advance_order.sql
-- ============================================================
...
-- ============================================================
-- Source: supabase/migrations/20260724_0008_fix_public_invoice_rpc.sql
-- ============================================================
...
-- ============================================================
-- Source: supabase/migrations/20260724_0009_create_invoices_bucket.sql
-- ============================================================
...
-- ============================================================
-- Source: supabase/migrations/20260726_0007_update_complete_advance_order_discount.sql
-- ============================================================
...
-- ============================================================
-- Source: supabase/migrations/20260728_0010_final_audit_fixes.sql
-- ============================================================
...
-- ============================================================
-- Source: supabase/migrations/20260808_0011_billing_date_and_order_fields.sql
-- ============================================================
...
-- ============================================================
-- Source: supabase/migrations/20260822_0001_new_modules.sql
-- ============================================================
...
-- ============================================================
-- Source: supabase/migrations/20260904_0001_tailoring_catalog_retired.sql
-- ============================================================
...
-- ============================================================
-- Source: supabase/migrations/20260906_0001_add_reconciliation_reason.sql
-- ============================================================
...
-- ============================================================
-- Source: supabase/migrations/20260907_0001_fix_attendance_clock_columns.sql
-- ============================================================
...
-- ============================================================
-- Source: supabase/migrations/20260914_0001_rice_n_rooster_rebrand.sql
-- ============================================================
...
-- ============================================================
-- Source: supabase/migrations/20260914_0002_fix_advance_order_inventory_deduction.sql
-- ============================================================
